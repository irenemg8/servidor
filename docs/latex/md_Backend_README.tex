\hypertarget{md_src_README_autotoc_md3518}{}\doxysection{¿\+Cómo funciona esta primera versión?}\label{md_src_README_autotoc_md3518}
He seguido las instrucciones de Jordi Bataller, creando una carpeta propia para Maria\+DB y Node.\+js, con sus respectivos Dockerfiles. Después, he creado un archivo {\ttfamily docker-\/compose.\+yml} que relaciona ambos contenedores y automatiza todo aquello que deberíamos hacer a mano.\hypertarget{md_src_README_autotoc_md3519}{}\doxysubsection{Maria\+DB}\label{md_src_README_autotoc_md3519}
...
\end{DoxyItemize}\hypertarget{md_src_README_autotoc_md3520}{}\doxysubsubsection{SQL}\label{md_src_README_autotoc_md3520}
...
\end{DoxyItemize}\hypertarget{md_src_README_autotoc_md3522}{}\doxysubsubsection{Servidor\+REST}\label{md_src_README_autotoc_md3522}
...
El funcionamiento de la API se puede ver de manera muy visual yendo a la siguiente dirección URL\+: \href{http://localhost:3000/api-docs/}{\texttt{ http\+://localhost\+:3000/api-\/docs/}}.\hypertarget{md_src_README_autotoc_md3523}{}\doxysubsection{docker-\/compose.\+yml}\label{md_src_README_autotoc_md3523}
