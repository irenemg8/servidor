...
Create and parse HTTP {\ttfamily Content-\/\+Disposition} header\hypertarget{md_src_nodejs_node_modules_content_disposition_README_autotoc_md550}{}\doxysection{Installation}\label{md_src_nodejs_node_modules_content_disposition_README_autotoc_md550}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm install content-\/disposition}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_content_disposition_README_autotoc_md551}{}\doxysection{API}\label{md_src_nodejs_node_modules_content_disposition_README_autotoc_md551}

\begin{DoxyCode}{0}
\DoxyCodeLine{var contentDisposition = require('content-\/disposition')}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_content_disposition_README_autotoc_md552}{}\doxysubsection{content\+Disposition(filename, options)}\label{md_src_nodejs_node_modules_content_disposition_README_autotoc_md552}
...
{\bfseries{note}} HTTP headers are of the ISO-\/8859-\/1 character set. If you are writing this header through a means different from {\ttfamily set\+Header} in Node.\+js, you\textquotesingle{}ll want to specify the `\textquotesingle{}binary'\`{} encoding in Node.\+js.\hypertarget{md_src_nodejs_node_modules_content_disposition_README_autotoc_md553}{}\doxysubsubsection{Options}\label{md_src_nodejs_node_modules_content_disposition_README_autotoc_md553}
{\ttfamily content\+Disposition} accepts these properties in the options object.\hypertarget{md_src_nodejs_node_modules_content_disposition_README_autotoc_md554}{}\doxyparagraph{fallback}\label{md_src_nodejs_node_modules_content_disposition_README_autotoc_md554}
...
If the {\ttfamily filename} option is ISO-\/8859-\/1 and this option is specified and has a different value, then the {\ttfamily filename} option is encoded in the extended field and this set as the fallback field, even though they are both ISO-\/8859-\/1.\hypertarget{md_src_nodejs_node_modules_content_disposition_README_autotoc_md555}{}\doxyparagraph{type}\label{md_src_nodejs_node_modules_content_disposition_README_autotoc_md555}
Specifies the disposition type, defaults to {\ttfamily \char`\"{}attachment\char`\"{}}. This can also be {\ttfamily \char`\"{}inline\char`\"{}}, or any other value (all values except inline are treated like {\ttfamily attachment}, but can convey additional information if both parties agree to it). The type is normalized to lower-\/case.\hypertarget{md_src_nodejs_node_modules_content_disposition_README_autotoc_md556}{}\doxysubsection{content\+Disposition.\+parse(string)}\label{md_src_nodejs_node_modules_content_disposition_README_autotoc_md556}
...
\end{DoxyItemize}\hypertarget{md_src_nodejs_node_modules_content_disposition_README_autotoc_md557}{}\doxysection{Examples}\label{md_src_nodejs_node_modules_content_disposition_README_autotoc_md557}
\hypertarget{md_src_nodejs_node_modules_content_disposition_README_autotoc_md558}{}\doxysubsection{Send a file for download}\label{md_src_nodejs_node_modules_content_disposition_README_autotoc_md558}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_content_disposition_README_autotoc_md559}{}\doxysection{Testing}\label{md_src_nodejs_node_modules_content_disposition_README_autotoc_md559}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm test}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_content_disposition_README_autotoc_md560}{}\doxysection{References}\label{md_src_nodejs_node_modules_content_disposition_README_autotoc_md560}
...
\end{DoxyItemize}\hypertarget{md_src_nodejs_node_modules_content_disposition_README_autotoc_md561}{}\doxysection{License}\label{md_src_nodejs_node_modules_content_disposition_README_autotoc_md561}
