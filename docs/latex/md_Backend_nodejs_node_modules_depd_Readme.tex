...
\hypertarget{md_src_nodejs_node_modules_depd_Readme_autotoc_md741}{}\doxysection{Install}\label{md_src_nodejs_node_modules_depd_Readme_autotoc_md741}
...
This module can also be bundled with systems like \href{http://browserify.org/}{\texttt{ Browserify}} or \href{https://webpack.github.io/}{\texttt{ webpack}}, though by default this module will alter it\textquotesingle{}s API to no longer display or track deprecations.\hypertarget{md_src_nodejs_node_modules_depd_Readme_autotoc_md742}{}\doxysection{API}\label{md_src_nodejs_node_modules_depd_Readme_autotoc_md742}
...
If the message is omitted, a message is generated for you based on the site of the {\ttfamily deprecate()} call and will display the name of the function called, similar to the name displayed in a stack trace.\hypertarget{md_src_nodejs_node_modules_depd_Readme_autotoc_md745}{}\doxysubsection{deprecate.\+function(fn, message)}\label{md_src_nodejs_node_modules_depd_Readme_autotoc_md745}
Call this function to wrap a given function in a deprecation message on any call to the function. An optional message can be supplied to provide a custom message.\hypertarget{md_src_nodejs_node_modules_depd_Readme_autotoc_md746}{}\doxysubsection{deprecate.\+property(obj, prop, message)}\label{md_src_nodejs_node_modules_depd_Readme_autotoc_md746}
...
If the property is a data descriptor, it will be converted to an accessor descriptor in order to display the deprecation message.\hypertarget{md_src_nodejs_node_modules_depd_Readme_autotoc_md747}{}\doxysubsection{process.\+on(\textquotesingle{}deprecation\textquotesingle{}, fn)}\label{md_src_nodejs_node_modules_depd_Readme_autotoc_md747}
This module will allow easy capturing of deprecation errors by emitting the errors as the type \char`\"{}deprecation\char`\"{} on the global {\ttfamily process}. If there are no listeners for this type, the errors are written to STDERR as normal, but if there are any listeners, nothing will be written to STDERR and instead only emitted. From there, you can write the errors in a different format or to a logging source.
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_depd_Readme_autotoc_md748}{}\doxysubsection{process.\+env.\+NO\+\_\+\+DEPRECATION}\label{md_src_nodejs_node_modules_depd_Readme_autotoc_md748}
...
{\bfseries{NOTE}} This will not suppress the deperecations given to any \char`\"{}deprecation\char`\"{} event listeners, just the output to STDERR.\hypertarget{md_src_nodejs_node_modules_depd_Readme_autotoc_md749}{}\doxysubsection{process.\+env.\+TRACE\+\_\+\+DEPRECATION}\label{md_src_nodejs_node_modules_depd_Readme_autotoc_md749}
...
{\bfseries{NOTE}} This will not trace the deperecations silenced by {\ttfamily NO\+\_\+\+DEPRECATION}.\hypertarget{md_src_nodejs_node_modules_depd_Readme_autotoc_md750}{}\doxysection{Display}\label{md_src_nodejs_node_modules_depd_Readme_autotoc_md750}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_depd_Readme_autotoc_md751}{}\doxysection{Examples}\label{md_src_nodejs_node_modules_depd_Readme_autotoc_md751}
\hypertarget{md_src_nodejs_node_modules_depd_Readme_autotoc_md752}{}\doxysubsection{Deprecating all calls to a function}\label{md_src_nodejs_node_modules_depd_Readme_autotoc_md752}
This will display a deprecated message about \char`\"{}oldfunction\char`\"{} being deprecated from \char`\"{}my-\/module\char`\"{} on STDERR.
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_depd_Readme_autotoc_md753}{}\doxysubsection{Conditionally deprecating a function call}\label{md_src_nodejs_node_modules_depd_Readme_autotoc_md753}
This will display a deprecated message about \char`\"{}weirdfunction\char`\"{} being deprecated from \char`\"{}my-\/module\char`\"{} on STDERR when called with less than 2 arguments.
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_depd_Readme_autotoc_md754}{}\doxysubsection{Deprecating property access}\label{md_src_nodejs_node_modules_depd_Readme_autotoc_md754}
This will display a deprecated message about \char`\"{}oldprop\char`\"{} being deprecated from \char`\"{}my-\/module\char`\"{} on STDERR when accessed. A deprecation will be displayed when setting the value and when getting the value.
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_depd_Readme_autotoc_md755}{}\doxysection{License}\label{md_src_nodejs_node_modules_depd_Readme_autotoc_md755}
