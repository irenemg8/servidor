\href{https://npmjs.org/package/destroy}{\texttt{ }} \href{https://github.com/stream-utils/destroy/actions/workflows/ci.yml}{\texttt{ }} \href{https://coveralls.io/r/stream-utils/destroy?branch=master}{\texttt{ }} !\mbox{[}License\mbox{]}\mbox{[}license-\/image\mbox{]} \href{https://npmjs.org/package/destroy}{\texttt{ }}

Destroy a stream.

This module is meant to ensure a stream gets destroyed, handling different APIs and Node.\+js bugs.\hypertarget{md_src_nodejs_node_modules_destroy_README_autotoc_md757}{}\doxysection{API}\label{md_src_nodejs_node_modules_destroy_README_autotoc_md757}

\begin{DoxyCode}{0}
\DoxyCodeLine{var destroy = require('destroy')}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_destroy_README_autotoc_md758}{}\doxysubsection{destroy(stream \mbox{[}, suppress\mbox{]})}\label{md_src_nodejs_node_modules_destroy_README_autotoc_md758}
...
The function returns the {\ttfamily stream} passed in as the argument.\hypertarget{md_src_nodejs_node_modules_destroy_README_autotoc_md759}{}\doxysection{Example}\label{md_src_nodejs_node_modules_destroy_README_autotoc_md759}
