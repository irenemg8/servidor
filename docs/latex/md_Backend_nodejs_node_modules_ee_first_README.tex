...
Get the first event in a set of event emitters and event pairs, then clean up after itself.\hypertarget{md_src_nodejs_node_modules_ee_first_README_autotoc_md774}{}\doxysection{Install}\label{md_src_nodejs_node_modules_ee_first_README_autotoc_md774}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm install ee-\/first}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_ee_first_README_autotoc_md775}{}\doxysection{API}\label{md_src_nodejs_node_modules_ee_first_README_autotoc_md775}

\begin{DoxyCode}{0}
\DoxyCodeLine{var first = require('ee-\/first')}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_ee_first_README_autotoc_md776}{}\doxysubsection{first(arr, listener)}\label{md_src_nodejs_node_modules_ee_first_README_autotoc_md776}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_ee_first_README_autotoc_md777}{}\doxysubsubsection{.\+cancel()}\label{md_src_nodejs_node_modules_ee_first_README_autotoc_md777}
