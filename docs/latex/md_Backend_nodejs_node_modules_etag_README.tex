...
This module generates HTTP ETags (as defined in RFC 7232) for use in HTTP responses.\hypertarget{md_src_nodejs_node_modules_etag_README_autotoc_md857}{}\doxysection{Installation}\label{md_src_nodejs_node_modules_etag_README_autotoc_md857}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_etag_README_autotoc_md858}{}\doxysection{API}\label{md_src_nodejs_node_modules_etag_README_autotoc_md858}

\begin{DoxyCode}{0}
\DoxyCodeLine{var etag = require('etag')}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_etag_README_autotoc_md859}{}\doxysubsection{etag(entity, \mbox{[}options\mbox{]})}\label{md_src_nodejs_node_modules_etag_README_autotoc_md859}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_etag_README_autotoc_md860}{}\doxysubsubsection{Options}\label{md_src_nodejs_node_modules_etag_README_autotoc_md860}
{\ttfamily etag} accepts these properties in the options object.\hypertarget{md_src_nodejs_node_modules_etag_README_autotoc_md861}{}\doxyparagraph{weak}\label{md_src_nodejs_node_modules_etag_README_autotoc_md861}
Specifies if the generated ETag will include the weak validator mark (that is, the leading {\ttfamily W/}). The actual entity tag is the same. The default value is {\ttfamily false}, unless the {\ttfamily entity} is {\ttfamily fs.\+Stats}, in which case it is {\ttfamily true}.\hypertarget{md_src_nodejs_node_modules_etag_README_autotoc_md862}{}\doxysection{Testing}\label{md_src_nodejs_node_modules_etag_README_autotoc_md862}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm test}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_etag_README_autotoc_md863}{}\doxysection{Benchmark}\label{md_src_nodejs_node_modules_etag_README_autotoc_md863}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_etag_README_autotoc_md864}{}\doxysection{License}\label{md_src_nodejs_node_modules_etag_README_autotoc_md864}
