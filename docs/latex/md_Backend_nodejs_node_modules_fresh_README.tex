...
HTTP response freshness testing\hypertarget{md_src_nodejs_node_modules_fresh_README_autotoc_md1228}{}\doxysection{Installation}\label{md_src_nodejs_node_modules_fresh_README_autotoc_md1228}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_fresh_README_autotoc_md1229}{}\doxysection{API}\label{md_src_nodejs_node_modules_fresh_README_autotoc_md1229}

\begin{DoxyCode}{0}
\DoxyCodeLine{var fresh = require('fresh')}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_fresh_README_autotoc_md1230}{}\doxysubsection{fresh(req\+Headers, res\+Headers)}\label{md_src_nodejs_node_modules_fresh_README_autotoc_md1230}
...
There is a known issue that in certain versions of Safari, Safari will incorrectly make a request that allows this module to validate freshness of the resource even when Safari does not have a representation of the resource in the cache. The module \href{https://www.npmjs.com/package/jumanji}{\texttt{ jumanji}} can be used in an Express application to work-\/around this issue and also provides links to further reading on this Safari bug.\hypertarget{md_src_nodejs_node_modules_fresh_README_autotoc_md1232}{}\doxysection{Example}\label{md_src_nodejs_node_modules_fresh_README_autotoc_md1232}
\hypertarget{md_src_nodejs_node_modules_fresh_README_autotoc_md1233}{}\doxysubsection{API usage}\label{md_src_nodejs_node_modules_fresh_README_autotoc_md1233}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_fresh_README_autotoc_md1234}{}\doxysubsection{Using with Node.\+js http server}\label{md_src_nodejs_node_modules_fresh_README_autotoc_md1234}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_fresh_README_autotoc_md1235}{}\doxysection{License}\label{md_src_nodejs_node_modules_fresh_README_autotoc_md1235}
