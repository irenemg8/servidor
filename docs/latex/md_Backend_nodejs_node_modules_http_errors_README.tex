...
Create HTTP errors for Express, Koa, Connect, etc. with ease.\hypertarget{md_src_nodejs_node_modules_http_errors_README_autotoc_md1414}{}\doxysection{Install}\label{md_src_nodejs_node_modules_http_errors_README_autotoc_md1414}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_http_errors_README_autotoc_md1415}{}\doxysection{Example}\label{md_src_nodejs_node_modules_http_errors_README_autotoc_md1415}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_http_errors_README_autotoc_md1416}{}\doxysection{API}\label{md_src_nodejs_node_modules_http_errors_README_autotoc_md1416}
This is the current API, currently extracted from Koa and subject to change.\hypertarget{md_src_nodejs_node_modules_http_errors_README_autotoc_md1417}{}\doxysubsection{Error Properties}\label{md_src_nodejs_node_modules_http_errors_README_autotoc_md1417}
...
\end{DoxyItemize}\hypertarget{md_src_nodejs_node_modules_http_errors_README_autotoc_md1418}{}\doxysubsection{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}message\mbox{]}, \mbox{[}properties\mbox{]})}\label{md_src_nodejs_node_modules_http_errors_README_autotoc_md1418}
...
\end{DoxyItemize}\hypertarget{md_src_nodejs_node_modules_http_errors_README_autotoc_md1419}{}\doxysubsection{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}error\mbox{]}, \mbox{[}properties\mbox{]})}\label{md_src_nodejs_node_modules_http_errors_README_autotoc_md1419}
...
\item {\ttfamily properties} -\/ custom properties to attach to the object
\end{DoxyItemize}\hypertarget{md_src_nodejs_node_modules_http_errors_README_autotoc_md1420}{}\doxysubsection{create\+Error.\+is\+Http\+Error(val)}\label{md_src_nodejs_node_modules_http_errors_README_autotoc_md1420}
Determine if the provided {\ttfamily val} is an {\ttfamily Http\+Error}. This will return {\ttfamily true} if the error inherits from the {\ttfamily Http\+Error} constructor of this module or matches the \char`\"{}duck type\char`\"{} for an error this module creates. All outputs from the {\ttfamily create\+Error} factory will return {\ttfamily true} for this function, including if an non-\/{\ttfamily Http\+Error} was passed into the factory.\hypertarget{md_src_nodejs_node_modules_http_errors_README_autotoc_md1421}{}\doxysubsection{new create\+Error\mbox{[}code $\vert$$\vert$ name\mbox{]}(\mbox{[}msg\mbox{]}))}\label{md_src_nodejs_node_modules_http_errors_README_autotoc_md1421}
Create a new error object with the given message {\ttfamily msg}. The error object inherits from {\ttfamily create\+Error.\+Http\+Error}.
...
\end{DoxyItemize}\hypertarget{md_src_nodejs_node_modules_http_errors_README_autotoc_md1422}{}\doxysubsubsection{List of all constructors}\label{md_src_nodejs_node_modules_http_errors_README_autotoc_md1422}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{md_src_nodejs_node_modules_http_errors_README_autotoc_md1423}{}\doxysection{License}\label{md_src_nodejs_node_modules_http_errors_README_autotoc_md1423}
