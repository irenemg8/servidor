Add callbacks to requests in flight to avoid async duplication\hypertarget{md_src_nodejs_node_modules_inflight_README_autotoc_md1461}{}\doxysection{USAGE}\label{md_src_nodejs_node_modules_inflight_README_autotoc_md1461}
