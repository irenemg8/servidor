...
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1726}{}\doxysubsection{Why another LRU?}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1726}
...
\DoxyHorRuler{0}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1728}{}\doxysubsection{Install}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1728}
...
\DoxyHorRuler{0}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1730}{}\doxysubsection{Usage}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1730}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1731}{}\doxysubsubsection{Quickstart}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1731}
...
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1732}{}\doxysubsubsection{Import}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1732}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1733}{}\doxyparagraph{ES Modules}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1733}

\begin{DoxyCode}{0}
\DoxyCodeLine{import \{ createLRU \} from 'lru.min';}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1734}{}\doxyparagraph{Common\+JS}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1734}

\begin{DoxyCode}{0}
\DoxyCodeLine{const \{ createLRU \} = require('lru.min');}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1735}{}\doxyparagraph{Browser}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1735}
\begin{quote}
...
\end{DoxyItemize}\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1736}{}\doxysubsubsection{Create a new LRU Cache}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1736}
\begin{quote}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1737}{}\doxysubsubsection{Set a cache}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1737}
...
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1738}{}\doxysubsubsection{Get a cache}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1738}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1739}{}\doxysubsubsection{Peek a cache}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1739}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1740}{}\doxysubsubsection{Check if a key exists}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1740}

\begin{DoxyCode}{0}
\DoxyCodeLine{LRU.has('key');}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1741}{}\doxysubsubsection{Delete a cache}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1741}

\begin{DoxyCode}{0}
\DoxyCodeLine{LRU.delete('key');}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1742}{}\doxysubsubsection{Evict from the oldest cache}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1742}
...
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1743}{}\doxysubsubsection{Resize the cache}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1743}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1744}{}\doxysubsubsection{Clear the cache}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1744}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1745}{}\doxysubsubsection{Debugging}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1745}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1746}{}\doxyparagraph{Get the max size of the cache}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1746}

\begin{DoxyCode}{0}
\DoxyCodeLine{LRU.max;}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1747}{}\doxyparagraph{Get the current size of the cache}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1747}

\begin{DoxyCode}{0}
\DoxyCodeLine{LRU.size;}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1748}{}\doxyparagraph{Get the available slots in the cache}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1748}

\begin{DoxyCode}{0}
\DoxyCodeLine{LRU.available;}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1749}{}\doxysubsubsection{Iterating the cache}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1749}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1750}{}\doxyparagraph{Get all keys}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1750}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1751}{}\doxyparagraph{Get all values}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1751}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1752}{}\doxyparagraph{Get all entries}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1752}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1753}{}\doxyparagraph{Run a callback for each entry}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1753}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1754}{}\doxysubsubsection{Type\+Script}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1754}
...
\DoxyHorRuler{0}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1756}{}\doxysubsubsection{Performance}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1756}
...
\DoxyHorRuler{0}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1758}{}\doxysubsection{Security Policy}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1758}
...
\DoxyHorRuler{0}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1760}{}\doxysubsection{Contributing}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1760}
...
\DoxyHorRuler{0}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1762}{}\doxysubsection{Acknowledgements}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1762}
...
\DoxyHorRuler{0}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1764}{}\doxyparagraph{What comes from $<$a href=\char`\"{}https\+://github.\+com/isaacs/node-\/lru-\/cache\char`\"{} $>$$<$strong$>$lru-\/cache$<$/strong$>$$<$/a$>$?}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1764}
...
\DoxyHorRuler{0}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1766}{}\doxyparagraph{What comes from $<$a href=\char`\"{}https\+://github.\+com/sindresorhus/quick-\/lru\char`\"{} $>$$<$strong$>$quick-\/lru$<$/strong$>$$<$/a$>$?}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1766}
...
\DoxyHorRuler{0}
\hypertarget{md_src_nodejs_node_modules_lru_min_README_autotoc_md1768}{}\doxysubsection{License}\label{md_src_nodejs_node_modules_lru_min_README_autotoc_md1768}
