...
\item In-\/browser usage via \href{https://github.com/substack/node-browserify}{\texttt{ browserify}} or \href{https://webpack.js.org/}{\texttt{ webpack}} ($\sim$180kb gzip compressed with Buffer shim included).
...
\href{https://npmjs.org/package/iconv-lite/}{\texttt{ }} ~\newline
 \href{https://travis-ci.org/ashtuchkin/iconv-lite}{\texttt{ }} \href{https://npmjs.org/package/iconv-lite/}{\texttt{ }} \href{https://npmjs.org/package/iconv-lite/}{\texttt{ }} \href{https://npmjs.org/package/iconv-lite/}{\texttt{ }}\hypertarget{md_src_nodejs_node_modules_mariadb_node_modules_iconv_lite_README_autotoc_md1802}{}\doxysection{Usage}\label{md_src_nodejs_node_modules_mariadb_node_modules_iconv_lite_README_autotoc_md1802}
\hypertarget{md_src_nodejs_node_modules_mariadb_node_modules_iconv_lite_README_autotoc_md1803}{}\doxysubsection{Basic API}\label{md_src_nodejs_node_modules_mariadb_node_modules_iconv_lite_README_autotoc_md1803}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_mariadb_node_modules_iconv_lite_README_autotoc_md1804}{}\doxysubsection{Streaming API}\label{md_src_nodejs_node_modules_mariadb_node_modules_iconv_lite_README_autotoc_md1804}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_mariadb_node_modules_iconv_lite_README_autotoc_md1805}{}\doxysection{Supported encodings}\label{md_src_nodejs_node_modules_mariadb_node_modules_iconv_lite_README_autotoc_md1805}
...
Multibyte encodings are generated from \href{http://www.unicode.org/Public/MAPPINGS/}{\texttt{ Unicode.\+org mappings}} and \href{http://encoding.spec.whatwg.org/}{\texttt{ WHATWG Encoding Standard mappings}}. Thank you, respective authors!\hypertarget{md_src_nodejs_node_modules_mariadb_node_modules_iconv_lite_README_autotoc_md1806}{}\doxysection{Encoding/decoding speed}\label{md_src_nodejs_node_modules_mariadb_node_modules_iconv_lite_README_autotoc_md1806}
...
\end{DoxyVerb}
 \hypertarget{md_src_nodejs_node_modules_mariadb_node_modules_iconv_lite_README_autotoc_md1807}{}\doxysection{BOM handling}\label{md_src_nodejs_node_modules_mariadb_node_modules_iconv_lite_README_autotoc_md1807}
...
\end{DoxyItemize}\hypertarget{md_src_nodejs_node_modules_mariadb_node_modules_iconv_lite_README_autotoc_md1808}{}\doxysection{UTF-\/16 Encodings}\label{md_src_nodejs_node_modules_mariadb_node_modules_iconv_lite_README_autotoc_md1808}
...
\end{DoxyItemize}\hypertarget{md_src_nodejs_node_modules_mariadb_node_modules_iconv_lite_README_autotoc_md1809}{}\doxysection{UTF-\/32 Encodings}\label{md_src_nodejs_node_modules_mariadb_node_modules_iconv_lite_README_autotoc_md1809}
...
\end{DoxyItemize}\hypertarget{md_src_nodejs_node_modules_mariadb_node_modules_iconv_lite_README_autotoc_md1810}{}\doxysection{Other notes}\label{md_src_nodejs_node_modules_mariadb_node_modules_iconv_lite_README_autotoc_md1810}
...
\hypertarget{md_src_nodejs_node_modules_mariadb_node_modules_iconv_lite_README_autotoc_md1811}{}\doxysection{Testing}\label{md_src_nodejs_node_modules_mariadb_node_modules_iconv_lite_README_autotoc_md1811}
