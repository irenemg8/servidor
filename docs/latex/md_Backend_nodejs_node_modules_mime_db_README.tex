...
\end{DoxyItemize}\hypertarget{md_src_nodejs_node_modules_mime_db_README_autotoc_md1911}{}\doxysection{Installation}\label{md_src_nodejs_node_modules_mime_db_README_autotoc_md1911}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm install mime-\/db}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_mime_db_README_autotoc_md1912}{}\doxysubsection{Database Download}\label{md_src_nodejs_node_modules_mime_db_README_autotoc_md1912}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_mime_db_README_autotoc_md1913}{}\doxysection{Usage}\label{md_src_nodejs_node_modules_mime_db_README_autotoc_md1913}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_mime_db_README_autotoc_md1914}{}\doxysection{Data Structure}\label{md_src_nodejs_node_modules_mime_db_README_autotoc_md1914}
...
If unknown, every property could be {\ttfamily undefined}.\hypertarget{md_src_nodejs_node_modules_mime_db_README_autotoc_md1915}{}\doxysection{Contributing}\label{md_src_nodejs_node_modules_mime_db_README_autotoc_md1915}
...
To update the build, run {\ttfamily npm run build}.\hypertarget{md_src_nodejs_node_modules_mime_db_README_autotoc_md1916}{}\doxysubsection{Adding Custom Media Types}\label{md_src_nodejs_node_modules_mime_db_README_autotoc_md1916}
...
If that is not possible / feasible, they can be added directly here as a \char`\"{}custom\char`\"{} type. To do this, it is required to have a primary source that definitively lists the media type. If an extension is going to be listed as associateed with this media type, the source must definitively link the media type and extension as well. 