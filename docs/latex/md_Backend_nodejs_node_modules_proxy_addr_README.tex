...
Determine address of proxied request\hypertarget{md_src_nodejs_node_modules_proxy_addr_README_autotoc_md2546}{}\doxysection{Install}\label{md_src_nodejs_node_modules_proxy_addr_README_autotoc_md2546}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_proxy_addr_README_autotoc_md2547}{}\doxysection{API}\label{md_src_nodejs_node_modules_proxy_addr_README_autotoc_md2547}

\begin{DoxyCode}{0}
\DoxyCodeLine{var proxyaddr = require('proxy-\/addr')}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_proxy_addr_README_autotoc_md2548}{}\doxysubsection{proxyaddr(req, trust)}\label{md_src_nodejs_node_modules_proxy_addr_README_autotoc_md2548}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_proxy_addr_README_autotoc_md2550}{}\doxysubsection{proxyaddr.\+compile(val)}\label{md_src_nodejs_node_modules_proxy_addr_README_autotoc_md2550}
...
This function is meant to be optimized for use against every request. It is recommend to compile a trust function up-\/front for the trusted configuration and pass that to {\ttfamily proxyaddr(req, trust)} for each request.\hypertarget{md_src_nodejs_node_modules_proxy_addr_README_autotoc_md2551}{}\doxysection{Testing}\label{md_src_nodejs_node_modules_proxy_addr_README_autotoc_md2551}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm test}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_proxy_addr_README_autotoc_md2552}{}\doxysection{Benchmarks}\label{md_src_nodejs_node_modules_proxy_addr_README_autotoc_md2552}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm run-\/script bench}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_proxy_addr_README_autotoc_md2553}{}\doxysection{License}\label{md_src_nodejs_node_modules_proxy_addr_README_autotoc_md2553}
