 ...
 \hypertarget{md_src_nodejs_node_modules_qs_README_autotoc_md2635}{}\doxysection{qs $<$sup$>$$<$a href=\char`\"{}https\+://npmjs.\+org/package/qs\char`\"{} $>$$<$img src=\char`\"{}https\+://versionbadg.\+es/ljharb/qs.\+svg\char`\"{} alt=\char`\"{}\+Version Badge\char`\"{}/$>$$<$/a$>$$<$/sup$>$}\label{md_src_nodejs_node_modules_qs_README_autotoc_md2635}
...
The {\bfseries{qs}} module was originally created and maintained by \href{https://github.com/visionmedia/node-querystring}{\texttt{ TJ Holowaychuk}}.\hypertarget{md_src_nodejs_node_modules_qs_README_autotoc_md2636}{}\doxysubsection{Usage}\label{md_src_nodejs_node_modules_qs_README_autotoc_md2636}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_qs_README_autotoc_md2637}{}\doxysubsubsection{Parsing Objects}\label{md_src_nodejs_node_modules_qs_README_autotoc_md2637}
...
It also works when the charset has been detected in {\ttfamily charset\+Sentinel} mode.\hypertarget{md_src_nodejs_node_modules_qs_README_autotoc_md2638}{}\doxysubsubsection{Parsing Arrays}\label{md_src_nodejs_node_modules_qs_README_autotoc_md2638}
...
\end{DoxyCode}
 ({\itshape this cannot convert nested objects, such as {\ttfamily a=\{b\+:1\},\{c\+:d\}}})\hypertarget{md_src_nodejs_node_modules_qs_README_autotoc_md2639}{}\doxysubsubsection{Parsing primitive/scalar values (numbers, booleans, null, etc)}\label{md_src_nodejs_node_modules_qs_README_autotoc_md2639}
...
If you wish to auto-\/convert values which look like numbers, booleans, and other values into their primitive counterparts, you can use the \href{https://github.com/xpepermint/query-types}{\texttt{ query-\/types Express JS middleware}} which will auto-\/convert all request query parameters.\hypertarget{md_src_nodejs_node_modules_qs_README_autotoc_md2640}{}\doxysubsubsection{Stringifying}\label{md_src_nodejs_node_modules_qs_README_autotoc_md2640}
\mbox{[}\mbox{]}(\#prevent\+Eval) 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_qs_README_autotoc_md2641}{}\doxysubsubsection{Handling of $<$tt$>$null$<$/tt$>$ values}\label{md_src_nodejs_node_modules_qs_README_autotoc_md2641}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_qs_README_autotoc_md2642}{}\doxysubsubsection{Dealing with special character sets}\label{md_src_nodejs_node_modules_qs_README_autotoc_md2642}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_qs_README_autotoc_md2643}{}\doxysubsubsection{RFC 3986 and RFC 1738 space encoding}\label{md_src_nodejs_node_modules_qs_README_autotoc_md2643}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_qs_README_autotoc_md2644}{}\doxysubsection{Security}\label{md_src_nodejs_node_modules_qs_README_autotoc_md2644}
Please email \href{https://github.com/ljharb}{\texttt{ @ljharb}} or see \href{https://tidelift.com/security}{\texttt{ https\+://tidelift.\+com/security}} if you have a potential security vulnerability to report.\hypertarget{md_src_nodejs_node_modules_qs_README_autotoc_md2645}{}\doxysubsection{qs for enterprise}\label{md_src_nodejs_node_modules_qs_README_autotoc_md2645}
Available as part of the Tidelift Subscription

The maintainers of qs and thousands of other packages are working with Tidelift to deliver commercial support and maintenance for the open source dependencies you use to build your applications. Save time, reduce risk, and improve code health, while paying the maintainers of the exact dependencies you use. \href{https://tidelift.com/subscription/pkg/npm-qs?utm_source=npm-qs&utm_medium=referral&utm_campaign=enterprise&utm_term=repo}{\texttt{ Learn more.}}\hypertarget{md_src_nodejs_node_modules_qs_README_autotoc_md2646}{}\doxysubsection{Acknowledgements}\label{md_src_nodejs_node_modules_qs_README_autotoc_md2646}
