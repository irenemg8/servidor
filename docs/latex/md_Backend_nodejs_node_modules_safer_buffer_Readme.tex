Modern Buffer API polyfill without footguns, working on Node.\+js from 0.\+8 to current.\hypertarget{md_src_nodejs_node_modules_safer_buffer_Readme_autotoc_md2777}{}\doxysection{How to use?}\label{md_src_nodejs_node_modules_safer_buffer_Readme_autotoc_md2777}
...
Also, see the \href{https://github.com/ChALkeR/safer-buffer/blob/master/Porting-Buffer.md}{\texttt{ porting Buffer}} guide.\hypertarget{md_src_nodejs_node_modules_safer_buffer_Readme_autotoc_md2778}{}\doxysection{Do I need it?}\label{md_src_nodejs_node_modules_safer_buffer_Readme_autotoc_md2778}
...
See the \href{https://github.com/ChALkeR/safer-buffer/blob/master/Porting-Buffer.md}{\texttt{ porting guide}} for a better description.\hypertarget{md_src_nodejs_node_modules_safer_buffer_Readme_autotoc_md2779}{}\doxysection{Why not $<$a href=\char`\"{}https\+://npmjs.\+com/safe-\/buffer\char`\"{} $>$safe-\/buffer$<$/a$>$?}\label{md_src_nodejs_node_modules_safer_buffer_Readme_autotoc_md2779}
...
Also, {\ttfamily safer-\/buffer} discourages the usage of {\ttfamily .alloc\+Unsafe()}, which is often done by a mistake. It still supports it with an explicit concern barier, by placing it under `require(\textquotesingle{}safer-\/buffer/dangereous')\`{}.\hypertarget{md_src_nodejs_node_modules_safer_buffer_Readme_autotoc_md2780}{}\doxysection{But isn\textquotesingle{}t throwing bad?}\label{md_src_nodejs_node_modules_safer_buffer_Readme_autotoc_md2780}
...
New commits, if tested, won\textquotesingle{}t land new usage of unsafe Buffer API this way. {\itshape Node.\+js 10.\+x also deals with that by printing a runtime depecation warning.}\hypertarget{md_src_nodejs_node_modules_safer_buffer_Readme_autotoc_md2781}{}\doxysubsection{Would it affect third-\/party modules?}\label{md_src_nodejs_node_modules_safer_buffer_Readme_autotoc_md2781}
No, unless you explicitly do an awful thing like monkey-\/patching or overriding the built-\/in {\ttfamily Buffer}. Don\textquotesingle{}t do that.\hypertarget{md_src_nodejs_node_modules_safer_buffer_Readme_autotoc_md2782}{}\doxysubsection{But I don\textquotesingle{}t want throwing…}\label{md_src_nodejs_node_modules_safer_buffer_Readme_autotoc_md2782}
That is also fine!
...
Note that using a linter to catch accidential {\ttfamily Buffer} constructor usage in this case is strongly recommended. {\ttfamily Buffer} is not overriden in this usecase, so linters won\textquotesingle{}t get confused.\hypertarget{md_src_nodejs_node_modules_safer_buffer_Readme_autotoc_md2783}{}\doxysection{«\+Without footguns»?}\label{md_src_nodejs_node_modules_safer_buffer_Readme_autotoc_md2783}
