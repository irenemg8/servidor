...
\end{DoxyItemize}\hypertarget{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3317}{}\doxysection{Usage}\label{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3317}
Install using npm\+:
...
If you want to set up routing based on the swagger document checkout \href{https://www.npmjs.com/package/swagger-express-router}{\texttt{ swagger-\/express-\/router}}\hypertarget{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3318}{}\doxysubsection{$<$a href=\char`\"{}https\+://www.\+npmjs.\+com/package/swagger-\/jsdoc\char`\"{} $>$swagger-\/jsdoc$<$/a$>$}\label{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3318}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3319}{}\doxysubsection{Swagger Explorer}\label{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3319}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3320}{}\doxysubsection{Custom swagger options}\label{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3320}
...
For all the available options, refer to \href{https://github.com/swagger-api/swagger-ui/blob/master/docs/usage/configuration.md}{\texttt{ Swagger UI Configuration}}\hypertarget{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3321}{}\doxysubsection{Custom CSS styles}\label{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3321}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3322}{}\doxysubsection{Custom CSS styles from Url}\label{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3322}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3323}{}\doxysubsection{Custom JS}\label{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3323}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3324}{}\doxysubsection{Load swagger from url}\label{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3324}
...
Make sure \textquotesingle{}explorer\textquotesingle{} option is set to \textquotesingle{}true\textquotesingle{} in your setup options for the dropdown to be visible.\hypertarget{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3325}{}\doxysubsection{Load swagger from yaml file}\label{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3325}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3326}{}\doxysubsection{Modify swagger file on the fly before load}\label{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3326}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3327}{}\doxysubsection{Two swagger documents}\label{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3327}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3328}{}\doxysubsection{Link to Swagger document}\label{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3328}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3329}{}\doxysection{Requirements}\label{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3329}

\begin{DoxyItemize}
\item Node v0.\+10.\+32 or above
\item Express 4 or above
\end{DoxyItemize}\hypertarget{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3330}{}\doxysection{Testing}\label{md_src_nodejs_node_modules_swagger_ui_express_README_autotoc_md3330}
