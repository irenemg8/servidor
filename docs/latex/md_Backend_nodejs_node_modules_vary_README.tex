...
Manipulate the HTTP Vary header\hypertarget{md_src_nodejs_node_modules_vary_README_autotoc_md3413}{}\doxysection{Installation}\label{md_src_nodejs_node_modules_vary_README_autotoc_md3413}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_vary_README_autotoc_md3414}{}\doxysection{API}\label{md_src_nodejs_node_modules_vary_README_autotoc_md3414}

\begin{DoxyCode}{0}
\DoxyCodeLine{var vary = require('vary')}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_vary_README_autotoc_md3415}{}\doxysubsection{vary(res, field)}\label{md_src_nodejs_node_modules_vary_README_autotoc_md3415}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_vary_README_autotoc_md3416}{}\doxysubsection{vary.\+append(header, field)}\label{md_src_nodejs_node_modules_vary_README_autotoc_md3416}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_vary_README_autotoc_md3417}{}\doxysection{Examples}\label{md_src_nodejs_node_modules_vary_README_autotoc_md3417}
\hypertarget{md_src_nodejs_node_modules_vary_README_autotoc_md3418}{}\doxysubsection{Updating the Vary header when content is based on it}\label{md_src_nodejs_node_modules_vary_README_autotoc_md3418}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_vary_README_autotoc_md3419}{}\doxysection{Testing}\label{md_src_nodejs_node_modules_vary_README_autotoc_md3419}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm test}

\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_vary_README_autotoc_md3420}{}\doxysection{License}\label{md_src_nodejs_node_modules_vary_README_autotoc_md3420}
