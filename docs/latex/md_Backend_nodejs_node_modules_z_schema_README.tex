...
\end{DoxyItemize}\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3476}{}\doxysection{Topics}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3476}
...
\item Benchmarks
\item Contributors
\end{DoxyItemize}\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3477}{}\doxysection{Usage}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3477}
Validator will try to perform sync validation when possible for speed, but supports async callbacks when they are necessary.\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3478}{}\doxysubsection{Development\+:}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3478}
These repository has several submodules and should be cloned as follows\+: \texorpdfstring{$>$}{>}git clone {\bfseries{--recursive}} \href{https://github.com/zaggino/z-schema.git}{\texttt{ https\+://github.\+com/zaggino/z-\/schema.\+git}}\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3479}{}\doxysubsection{CLI\+:}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3479}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3480}{}\doxysubsection{Node\+JS\+:}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3480}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3481}{}\doxysubsection{Sync mode\+:}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3481}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3482}{}\doxysubsection{Async mode\+:}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3482}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3483}{}\doxysubsection{Browser\+:}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3483}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3484}{}\doxysubsection{Remote references and schemas\+:}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3484}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3485}{}\doxysection{Features}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3485}
...
\end{DoxyItemize}\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3486}{}\doxysubsection{Validate against subschema}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3486}
...
See more details in the \href{/test/spec/schemaPathSpec.js}{\texttt{ test}}.\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3487}{}\doxysubsection{Compile arrays of schemas and use references between them}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3487}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3488}{}\doxysubsection{Register a custom format}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3488}
...
\end{DoxyCode}
 \hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3489}{}\doxysubsection{Helper method to check the formats that have been registered}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3489}
...
\end{DoxyCode}
 \hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3490}{}\doxysubsection{Automatic downloading of remote schemas}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3490}
Automatic downloading of remote schemas was removed from version {\ttfamily 3.\+x} but is still possible with a bit of extra code, see \href{test/spec/AutomaticSchemaLoadingSpec.js}{\texttt{ this test}} for more information on this.\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3491}{}\doxysubsection{Prefill default values to object using format}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3491}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3492}{}\doxysection{Options}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3492}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3493}{}\doxysubsection{async\+Timeout}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3493}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3494}{}\doxysubsection{no\+Empty\+Arrays}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3494}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3495}{}\doxysubsection{no\+Empty\+Strings}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3495}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3496}{}\doxysubsection{no\+Typeless}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3496}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3497}{}\doxysubsection{no\+Extra\+Keywords}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3497}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3498}{}\doxysubsection{assume\+Additional}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3498}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3499}{}\doxysubsection{force\+Additional}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3499}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3500}{}\doxysubsection{force\+Items}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3500}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3501}{}\doxysubsection{force\+Min\+Items}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3501}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3502}{}\doxysubsection{force\+Max\+Items}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3502}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3503}{}\doxysubsection{force\+Min\+Length}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3503}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3504}{}\doxysubsection{force\+Max\+Length}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3504}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3505}{}\doxysubsection{force\+Properties}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3505}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3506}{}\doxysubsection{ignore\+Unresolvable\+References}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3506}
...
\end{DoxyCode}
 \hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3507}{}\doxysubsection{enum\+Case\+Insensitive\+Comparison}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3507}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3508}{}\doxysubsection{strict\+Uris}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3508}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3509}{}\doxysubsection{strict\+Mode}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3509}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3510}{}\doxysubsection{break\+On\+First\+Error}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3510}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3511}{}\doxysubsection{report\+Path\+As\+Array}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3511}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3512}{}\doxysubsection{ignore\+Unknown\+Formats}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3512}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3513}{}\doxysubsection{include\+Errors}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3513}
...
\end{DoxyCode}
\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3514}{}\doxysubsection{custom\+Validator}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3514}
...
\end{DoxyCode}
 {\bfseries{Note\+:}} before creating your own keywords you should consider all compatibility issues.\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3515}{}\doxysection{Benchmarks}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3515}
...
\href{https://rawgithub.com/zaggino/z-schema/master/benchmark/results.html}{\texttt{ rawgithub.\+com/zaggino/z-\/schema/master/benchmark/results.html}}\hypertarget{md_src_nodejs_node_modules_z_schema_README_autotoc_md3516}{}\doxysection{Contributors}\label{md_src_nodejs_node_modules_z_schema_README_autotoc_md3516}
